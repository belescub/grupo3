...
<div class=container py-5>
   <h2 class="text-uppercase mb-4" style="font-family: 'Bebas Neue'; color: #77c040; letter-spacing: 2px;">
    ...
    <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/Vinilos/Flower Boy - Tyler, The Creator.jpg') }}" class="card-img-fluid catalog-img" alt="producto 1">
            <div class="catalog-info mt-2">
    ...
    <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/Vinilos/Harrys House - Harry Styles.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
        ...
        <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/Vinilos/I Barely Know Her - Sombr.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
    ...
    <div class="col">
        ...
        <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/Vinilos/Sheet Heart Attack - QUEEN.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
    ...
    <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/Vinilos/Rosie - Rosé.png') }}" class="card-img-fluid catalog-img" alt="producto 1">
            <div class="catalog-info mt-2">
    ...
    <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/Vinilos/Songs About Jane - Maroon 5.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
    ...
    <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/Vinilos/Hit me hard and soft -  Billie Eilish.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
    ...
    @if($categoria == 'reproductores' || $categoria == 'todos')
        <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/Reproductores/Kickback Retradisc.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
    ...
    <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/Reproductores/Mp4-Mp4.jpg') }}" class="card-img-fluid catalog-img" alt="producto 1">
            <div class="catalog-info mt-2">
    ...
    <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/Reproductores/Reproductor de Cds estilo retro.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
        ...
        <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/Reproductores/Tocadiscos-Rosita.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
...
@if($categoria == 'accesorios' || $categoria == 'todos')
    <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/accesorios/Auricular-Negro.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
    ...
    <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/accesorios/Kit de Limpieza de Vinilos 4 en 1.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
        ...
        <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/accesorios/Kit de limpieza vinilo Collector Protector.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
    ...
    <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/accesorios/Parlante-chiquito.jpg') }}" class="card-img-fluid catalog-img" alt="producto 1">
            <div class="catalog-info mt-2">
    ...
    <div class="col">
        <div class="catalog-item">
            <img src="{{ asset('assets/img/accesorios/Parlante-Grande.jpg') }}" class="card-img-fluid catalog-img" alt="producto 2">
            <div class="catalog-info mt-2">
